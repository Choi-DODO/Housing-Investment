...
* Main Model: cur_inc
regress own $cur_inc , vce(cluster rc)
outreg2 using Results/table_main.xls,   replace se label dec(3) excel
regress own $cur_inc $covariate , vce(cluster rc)
outreg2 using Results/table_main.xls,   append se label dec(3) excel
regress own $cur_inc $covariate $region , vce(cluster rc)
outreg2 using Results/table_main.xls,   append se label dec(3) excel
...
* interaction
regress own $cur_inc $covariate c.val_rent#1.ac $region , vce(cluster rc) //*
outreg2 using Results/table_inter.xls,   replace se label dec(3) excel
regress own $cur_inc $covariate c.val_rent#3.ac $region , vce(cluster rc) //*
outreg2 using Results/table_inter.xls,   append se label dec(3) excel
regress own $cur_inc $covariate c.val_rent#i.gender $region , vce(cluster rc) //*
outreg2 using Results/table_inter.xls,   append se label dec(3) excel
regress own $cur_inc $covariate c.val_rent#i.col_grd $region , vce(cluster rc) //*
outreg2 using Results/table_inter.xls,   append se label dec(3) excel
regress own $cur_inc $covariate c.val_rent#i.other $region , vce(cluster rc) //*
outreg2 using Results/table_inter.xls,   append se label dec(3) excel
regress own $cur_inc $covariate c.val_rent#i.nohouse $region ,vce(cluster rc)//*
outreg2 using Results/table_inter.xls,   append se label dec(3) excel
